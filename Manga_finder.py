...
if __name__ == "__main__":
    ...
    ebay_url = f"https://www.ebay.com/sch/i.html?_from=R40&_trksid=m570.l1313&_nkw={manga}+manga+{language_preference}&_png=1"
    ...
    while x <= 3:
        x = x + 1
        ebay_url = f"https://www.ebay.com/sch/i.html?_from=R40&_trksid=m570.l1313&_nkw={manga}+manga+{language_preference}&_png={x}"
